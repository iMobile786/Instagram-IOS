...
static NSString* kDialogBaseURL = @"http://instagram.com/";
static NSString* kRestserverBaseURL = @"http://api.instagram.com/v1/";;
...
- (NSString *)getOwnBaseUrl {
    NSLog(@"REDIRECT URL: %@",[NSString stringWithFormat:@"ig%@://authorize", self.clientId]);
